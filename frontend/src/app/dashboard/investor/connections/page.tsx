      ...
      <DashboardLayout userRole="investor">
        <div className="space-y-6">
          <div>
            ...
            <p className="text-muted-foreground">Manage your connection requests with entrepreneurs</p>
          </div>
              ...
              {isLoading ? (
                ...
                <div className="flex flex-col items-center justify-center rounded-lg border border-dashed p-8 text-center">
                  ...
                  <p className="mt-2 text-sm text-muted-foreground">
                    You haven't received any connection requests from entrepreneurs yet.
                  </p>
                </div>
              )}
            </TabsContent>
            <TabsContent value="sent" className="space-y-4">
              {isLoading ? (
                ...
                <div className="flex flex-col items-center justify-center rounded-lg border border-dashed p-8 text-center">
                  ...
                  <p className="mt-2 text-sm text-muted-foreground">
                    You haven't sent any connection requests to entrepreneurs yet.
                  </p>
                </div>
              )}
            </TabsContent>
